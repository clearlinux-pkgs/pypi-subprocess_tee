...
Source0  : https://files.pythonhosted.org/packages/d7/22/991efbf35bc811dfe7edcd749253f0931d2d4838cf55176132633e1c82a7/subprocess_tee-0.4.2.tar.gz
...
%prep
%setup -q -n subprocess_tee-0.4.2
cd %{_builddir}/subprocess_tee-0.4.2
pushd ..
cp -a subprocess_tee-0.4.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718729972
...
cp %{_builddir}/subprocess_tee-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/pypi-subprocess_tee/3a8ca1ab43f7ee0b351aca14b5b2cda5ec3406e5 || :
