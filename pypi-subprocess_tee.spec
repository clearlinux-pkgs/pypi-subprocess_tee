...
Source0  : https://files.pythonhosted.org/packages/f6/a0/acafd85c7c0aead293a16a70a49aba20ba2af9478771370b2897eae6059c/subprocess-tee-0.4.1.tar.gz
...
%prep
%setup -q -n subprocess-tee-0.4.1
cd %{_builddir}/subprocess-tee-0.4.1
pushd ..
cp -a subprocess-tee-0.4.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707143532
