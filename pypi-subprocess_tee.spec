...
Source0  : https://files.pythonhosted.org/packages/76/1b/653bc93bf15738ab2fe83a875d28354cbe7402b12e22801d35e5461fe3f2/subprocess-tee-0.4.0.tar.gz
...
%prep
%setup -q -n subprocess-tee-0.4.0
cd %{_builddir}/subprocess-tee-0.4.0
pushd ..
cp -a subprocess-tee-0.4.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1669397683
...
cp %{_builddir}/subprocess-tee-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/pypi-subprocess_tee/3a8ca1ab43f7ee0b351aca14b5b2cda5ec3406e5 || :
